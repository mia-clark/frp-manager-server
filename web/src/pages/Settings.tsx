...
const Settings: React.FC = () => {
  ...
  const sysLabel = (k: SysField, text: string) => (
    <Space size={6}>
      {text}
      <Tooltip title="开：跟随 FRPCMGR_* 环境变量（保存即清除该项覆盖）；关：固定为下方填写的值">
        <Switch
          size="small"
    ...
    <Space direction="vertical" size={16} style={{ width: '100%' }}>
      ...
      >
        ...
        >
          ...
          >
            <Input placeholder="FRPC · 内网穿透客户端管理控制台" maxLength={120} allowClear />
          </Form.Item>
      ...
      {sysCfg && (
        ...
        >
          ...
          >
            ...
            <Form.Item wrapperCol={{ offset: 7 }} style={{ marginBottom: 0 }}>
              <Space>
                ...
                <Tooltip title="清除全部 UI 覆盖，回退到 FRPCMGR_* 环境变量默认值">
          ...
          <Alert
            ...
            description={
              <Text style={{ fontSize: 12 }}>
                这些原本是 FRPCMGR_* 环境变量（装机写死、改了要 SSH + 重启）。每行的「跟随 env」开关：
